import { DynamoDBBinaryResult, DynamoDBBinarySetResult, DynamoDBBooleanResult, DynamoDBFilterObject, DynamoDBListResult, DynamoDBMapResult, DynamoDBNullResult, DynamoDBNumberResult, DynamoDBNumberSetResult, DynamoDBReturnType, DynamoDBStringResult, DynamoDBStringSetResult, OpenSearchQueryObject, SubscriptionFilter, SubscriptionFilterExcludeKeysType, SubscriptionFilterObject, SubscriptionFilterRuleObject, Util } from '@aws-appsync/utils';
import { OptionalInputType } from '@aws-appsync/utils/lib/dynamodb-utils';
import { NormalizationType } from '@aws-appsync/utils/lib/string-utils';
